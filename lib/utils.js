/**
 * Debounce a callback by 250ms.
 * @param {function} cb The callback method to debounce.
 */
...
/**
 * Do a very nieve text truncation.
 * @param {text} The text to truncate.
 * @param {characters} The number of characters to truncate to.
 */
